...
function saveSimulationData(refString, frames, algorithm, hits, faults, hitRatio, missRatio) {
...
// Example usage inside your FIFO function:
function FIFO() {
  // ... your existing code for simulation

  // After you compute the results
  saveSimulationData(
    ref.join(" "),    // refString
    frames,           // number of frames
    "FIFO",           // algorithm
    obj.pageHits,     // hits
    obj.pageFaults,   // faults
