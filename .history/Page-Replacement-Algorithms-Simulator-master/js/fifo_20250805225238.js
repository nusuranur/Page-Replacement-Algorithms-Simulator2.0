function saveSimulationData(algorithm, refArray, hits, faults) {
    ...
    // ✅ Build parameters
const reference_string = encodeURIComponent(refString.join(" "));
const frames = document.getElementById("frames").value;

const params = `algorithm=${algorithm}&reference_string=${reference_string}&frames=${frames}&hits=${hits}&faults=${faults}&hit_ratio=${hitRatio}&miss_ratio=${missRatio}`;
