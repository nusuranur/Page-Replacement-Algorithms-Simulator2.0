...
const refStr = Array.isArray(refString) ? refString.join(" ") : refString;

const params = `algorithm=${algorithm}&reference_string=${encodeURIComponent(refStr)}&hits=${hits}&faults=${faults}&hit_ratio=${hitRatio}&miss_ratio=${faultRatio}`;

    console.log("Sending data to server:", params); // <-- Add this line
