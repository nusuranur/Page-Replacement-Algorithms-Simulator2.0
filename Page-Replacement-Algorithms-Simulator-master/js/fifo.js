function saveSimulationData(algorithm, refString, hits, faults) {
    ...
    const params = `algorithm=${algorithm}&ref_string=${refString.join(" ")}&hits=${hits}&faults=${faults}&hit_ratio=${hitRatio}&miss_ratio=${faultRatio}`;
    
    xhr.onreadystatechange = function() {
      if (xhr.readyState === 4) {
        console.log("🔁 Server Response:", xhr.responseText);  // ✅ log to console
      }
    };
